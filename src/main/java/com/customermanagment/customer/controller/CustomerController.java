package com.customermanagment.customer.controller;

import com.customermanagment.customer.models.Customer;
import com.customermanagment.customer.service.CustomerService;
...
public class CustomerController {
    ...
    public ResponseEntity<Customer> saveCustomer(@ResponseBody @Valid Customer customer){
    ...
    public ResponseEntity<Customer> updateCustomer( @ResponseBody @Valid Customer customer, UriComponentsBuilder builder){
        HttpHeaders headers= new HttpHeaders();
